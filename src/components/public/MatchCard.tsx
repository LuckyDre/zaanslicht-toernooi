...
function ElapsedTimer({ startedAt, matchMinutes }: { startedAt: string; matchMinutes: number }) {
  ...
  return (
    <span className="font-mono text-xs font-bold tabular-nums"
      style={{ color: overtime ? '#ef4444' : 'var(--green)' }}>
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {!isLive && !isFinished && expectedTime && (
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 px-3 py-1 rounded-lg font-mono font-bold text-lg flex-shrink-0"
